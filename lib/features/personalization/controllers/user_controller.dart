  ...
  uploadUserProfilePicture()async{
    try{
      ...
      if(image !=null){
        ...
        user.refresh();
        CLoaders.successSnackBar(title: "Congratulations!", message: "Your profile Image has been updated");
      }
    }
    catch(e){
      CLoaders.warningSnackBar(title: "Oh Snap!",message: "Something went wrong: $e");
    }finally{
